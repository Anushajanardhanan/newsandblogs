        ...
        children: [
                 ...
                 child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  const  Text("🔥Latest News",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
                                    ...
                                    (
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (ctx)=>Read_more(id: widget.id,)));
                                      },
           ...
           ListView.builder(
            ...
            itemBuilder:(ctx,index){
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Blog_details(blogId: data['id'],)));
                },
